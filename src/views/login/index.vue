...
export default {
  ...
  methods: {
    ...
    Code() {
      ...
      this.ruleForm.imgCode = "http://192.168.10.61:8087/web/check/"+ this.ruleForm.uuid + "?" + num;
  ...
  created(){
      const uuid =  Number(Math.random().toString().substr(3,length) + Date.now()).toString(36); 
      this.ruleForm.uuid = uuid
      this.ruleForm.imgCode = "http://192.168.10.61:8087/web/check/" + this.ruleForm.uuid ;
  },
    //关闭浏览器监听
  //   mounted () {
